...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    externalTokens: {
      ...
      USDC: ['0xb03525460f8E854799c04d6ADc309077401B5e27', 6],
      ...
      'DUKE-USDC-LP': ['0x888564723E172725E6967b97D121F8d7Eacb94C7', 18],
      'DSHARE-USDC-LP': ['0x88A4956716eF7FF17da8e0A93Fc7b3A2419f10D3', 18],
    },
